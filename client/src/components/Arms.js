    ...
    <div>
      ...
      <ul>
        ...
        <li>
          ...
          <label for="item2">Overhead Press or Dumbbell Shoulder Press: 3 sets of 8-10 reps</label>
        </li>
        <li>
          <input type="checkbox" id="item3" name="item3" value="item3" />
          <label for="item3">Dumbbell Lateral Raise: 3 sets of 12-15 reps</label>
        </li>
        <li>
          <input type="checkbox" id="item4" name="item4" value="item4" />
          <label for="item4">Dumbbell Front Raise: 3 sets of 12-15 reps</label>
        </li>
        <li>
          <input type="checkbox" id="item5" name="item5" value="item5" />
          <label for="item5">Triceps Dips: 2 sets of 10-12 reps</label>
        </li>
        <li>
          <input type="checkbox" id="item6" name="item6" value="item6" />
          <label for="item6">Triceps Extensions: 3 sets of 10-12 reps</label>
        </li>
        <li>
          <input type="checkbox" id="item7" name="item7" value="item7" />
          <label for="item7">Bicep Curls: 3 sets of 10-12 reps</label>
        </li>
        <li>
          <input type="checkbox" id="item8" name="item8" value="item8" />
          <label for="item8">Hammer Curls: 3 sets of 10-12 reps</label>
        </li>
        <li>
